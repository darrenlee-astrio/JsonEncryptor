...
using JsonEncryptor.Application.Services.Encryption.Models;
using System.Security;
using System.Security.Cryptography;

namespace JsonEncryptor.Application.Services.Encryption;
...
public class AesEncryptionService : EncryptionBase, IAesEncryptionService
{
    ...
    public SecureString Decrypt(string encryptedData, string key, int keySize, string iv)
    {
        ...
        using (Aes aesAlgorithm = Aes.Create())
        {
            ...
            {
                return CreateSecureString(srDecrypt.ReadToEnd());
            }
        }
    }
