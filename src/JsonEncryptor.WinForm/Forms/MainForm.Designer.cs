using JsonEncryptor.WinForm.Controls;
...
partial class MainForm
{
    ...
    private PlaceHolderTextBox textBoxFilePath;
    private Button buttonBrowseFile;
    private PlaceHolderTextBox textBoxJsonKeys;
    private Label labelAesKey;
    private PlaceHolderTextBox textBoxAesKey;
    private Button buttonGenerateAesKey;
    private Label labelAesIv;
    private PlaceHolderTextBox textBoxAesIv;
